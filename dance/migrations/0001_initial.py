    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('creator', models.OneToOneField(null=True, on_delete=django.db.models.deletion.SET_NULL, to='dance.Artist')),
            ],
        ),
        migrations.CreateModel(
            name='Tag',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('video', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='dance.Video')),
            ],
        ),
        migrations.AddField(
            model_name='step',
            name='tags',
            field=models.ManyToManyField(blank=True, related_name='steps', to='dance.Tag'),
        ),
    ]
